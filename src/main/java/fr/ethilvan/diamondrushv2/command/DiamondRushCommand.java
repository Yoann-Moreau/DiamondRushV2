...
import fr.ethilvan.diamondrushv2.command.game.*;
...
public class DiamondRushCommand implements TabExecutor {
	...
	public DiamondRushCommand(DiamondRush diamondRush) {
		...
		subcommands.add(new PauseCommand(diamondRush));
		subcommands.add(new ResumeCommand(diamondRush));
		subcommands.add(new SpectateCommand(diamondRush));
	}
